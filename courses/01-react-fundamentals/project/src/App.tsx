      ...
      <div className="App">
        <main>
          <Routes>
            ...
            <Route path="/challenge/12-categories-and-tags" element={<TaskApp tasks={tasks} dispatch={dispatch} showForm showFilterBar countFormat="tasks" onDelete={handleDelete} />} />
            <Route
