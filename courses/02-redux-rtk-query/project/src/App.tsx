      ...
      <div className="App">
        ...
        <main>
          <Routes>
            ...
            <Route path="/challenge/13-query-parameters" element={<div id="challenge-13" style={{ padding: '2rem' }}><h1>Challenge 13: Query with Parameters</h1><PostDetail /></div>} />
            <Route path="/challenge/13-query-parameters/:postId" element={<div id="challenge-13" style={{ padding: '2rem' }}><h1>Challenge 13: Query with Parameters</h1><PostDetail /></div>} />
          </Routes>
        </main>
      </div>
    </BrowserRouter>
