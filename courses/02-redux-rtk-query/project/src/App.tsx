      ...
      <div className="App">
        ...
        <main>
          <Routes>
            ...
            <Route path="/challenge/01-store-setup" element={<div id="challenge-01" style={{ padding: '2rem' }}><h1>Challenge 01</h1><h2>Store Setup</h2></div>} />
            ...
            <Route path="/challenge/07-queries" element={<div style={{ padding: '2rem' }}><h1>Challenge 07: Queries</h1><UsersList /></div>} />
            ...
            <Route path="/challenge/11-api-local-state" element={<div style={{ padding: '2rem' }}><h1>Challenge 11: API and Local State</h1><PostsWithFilters /></div>} />
            <Route path="/challenge/12-error-loading-ux" element={<div style={{ padding: '2rem' }}><h1>Challenge 12: Error and Loading UX</h1><UsersList /></div>} />
            <Route path="/challenge/13-query-parameters" element={<div id="challenge-13" style={{ padding: '2rem' }}><h1>Challenge 13: Query with Parameters</h1><PostDetail id={1} /></div>} />
            <Route path="/challenge/13-query-parameters/:postId" element={<div id="challenge-13" style={{ padding: '2rem' }}><h1>Challenge 13: Query with Parameters</h1><PostDetail id={1} /></div>} />
          </Routes>
        </main>
      </div>
    </BrowserRouter>
